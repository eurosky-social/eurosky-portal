...
This Privacy Notice explains how personal data is processed when you use the **Eurosky Personal Data Server (PDS)**. It applies specifically to the PDS and is separate from the Privacy Policy that applies to the Eurosky websites, mailing lists, and general communications.
...
For the purposes of the EU General Data Protection Regulation (GDPR), Stichting Modal is the data controller for personal data processed in connection with the operation of the Eurosky PDS.
...
Personal data stored on the Eurosky PDS is hosted on infrastructure located within the European Union.

To operate and secure the service, we may use service providers acting on our behalf as data processors (for example, for cloud infrastructure, monitoring, or security). Where such providers process personal data, they do so under contractual safeguards and in accordance with EU data protection law.
...
We aim to host and process PDS data within the European Union.

Where limited personal data related to the operation or security of the service is processed outside the European Union (for example, by certain security or monitoring providers), appropriate safeguards are in place in accordance with EU data protection law, including Standard Contractual Clauses approved by the European Commission.

---

### **9\. Data retention**

We retain PDS data for as long as your account is active.
...
We use appropriate technical and organisational measures to protect PDS data against unauthorised access, loss, or misuse.

---

### **12\. Changes to this notice**

We may update this Privacy Notice from time to time to reflect changes to the Eurosky PDS or to applicable law. The most recent version will always be published, with the date of the latest update indicated above.
