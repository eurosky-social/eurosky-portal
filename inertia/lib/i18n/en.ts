const en = {
  ...
  'createAccount.haveAccount': 'Already have a {appBrand} account? <signIn>Sign in</signIn>',
  ...
  'createAccount.title': 'Create your <brand>{appBrand} account.</brand>',
  ...
  'dashboard.explore.text':
    'Your {appBrand} account works with dozens of apps. Browse the featured apps below and click one to get started.',
  'dashboard.featuredApps.browseMore': 'Browse more apps',
  'dashboard.featuredApps.heading': 'Featured applications',
  'dashboard.featuredApps.text': 'Your {appBrand} account works with all of these.',
  ...
  'dashboard.welcome.text':
    '{appBrand} is your European home on the Atmosphere – a global network of social apps and services.',
  ...
  'hero.title': '{appBrand}: Your Portal to <brand>the Atmosphere.</brand>',
  ...
  'login.title': 'Sign into your <brand>{appBrand} account.</brand>',
