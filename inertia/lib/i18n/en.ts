const en = {
  ...
  'migrationAlert.cta': 'Migrate',
  'migrationAlert.text':
    'Bring your handle, posts, and followers to Eurosky with the migration tool. A new account can’t be merged with an existing one later.',
  'migrationAlert.title': 'Already have a Bluesky account?',
  'nav.about': 'About',
  'nav.apps': 'Apps',
